...
<div class="flex flex-col space-y-5 md:space-y-10">
    <div class="flex flex-col">
        ...
        <!-- <div class="flex items-center my-5">
            <img src="https://cdn-icons-png.flaticon.com/128/5882/5882377.png" class="w-5 h-5 mr-2" style="filter: invert(1);">
            <p class="text-2xl font-bold text-white">Badges</p>
        </div> -->
    ...
    <div class="flex flex-col">
        ...
        <?php else: ?>
            <div class="px-4 py-3 mb-2 bg-gray-700 rounded-lg">
                <p class="text-gray-400 text-center">No death records found.</p>
            </div>
        <?php endif; ?>
        </div>
    </div> 
